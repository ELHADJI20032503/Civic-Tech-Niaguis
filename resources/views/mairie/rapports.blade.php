...
<head>
    ...
    <title>Rapports - Civic-Tech Niaguis</title>
...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-nav">
            <li class="sidebar-nav-item"><a href="{{ route('mairie.tableau_de_bord') }}" class="sidebar-nav-link @if(Route::is('mairie.tableau_de_bord')) active @endif">📊 Tableau de bord</a></li>
            <li class="sidebar-nav-item"><a href="{{ route('mairie.dashboard') }}" class="sidebar-nav-link @if(Route::is('mairie.dashboard')) active @endif">📂 File d'attente<span class="badge bg-danger rounded-pill" style="font-size: 10px;">{{ $nb_en_attente }}</span></a></li>
            <li class="sidebar-nav-item"><a href="{{ route('mairie.documents') }}" class="sidebar-nav-link @if(Route::is('mairie.documents')) active @endif">📄 Documents civils</a></li>
            <li class="sidebar-nav-item"><a href="{{ route('mairie.citoyens') }}" class="sidebar-nav-link @if(Route::is('mairie.citoyens')) active @endif">👥 Citoyens</a></li>
            <li class="sidebar-nav-item"><a href="{{ route('mairie.rapports') }}" class="sidebar-nav-link @if(Route::is('mairie.rapports')) active @endif">📈 Rapports</a></li>
            <li class="sidebar-nav-item"><a href="{{ route('mairie.statistiques') }}" class="sidebar-nav-link @if(Route::is('mairie.statistiques')) active @endif">📊 Statistiques</a></li>
            <li class="sidebar-nav-item"><a href="{{ route('mairie.parametres') }}" class="sidebar-nav-link @if(Route::is('mairie.parametres')) active @endif">⚙️ Paramètres</a></li>
        </ul>
