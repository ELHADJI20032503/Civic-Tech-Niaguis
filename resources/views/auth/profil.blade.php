...
<body>
    ...
    <!-- Conteneur principal -->
    <div class="container d-flex flex-column justify-content-center" style="height: calc(100vh - 120px); max-width: 1000px; padding-bottom: 60px;">
...
} else {document.getElementById('card_officier').classList.add('selected-officier');}} 
